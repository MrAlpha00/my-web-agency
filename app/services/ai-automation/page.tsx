            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                ...
                <div className="max-w-3xl">
                    ...
                    <p className="text-lg md:text-xl text-zinc-400 leading-relaxed mb-10">
                        Intelligent workflows and AI agents that generate revenue without manual intervention. Scale your operations sustainably.
                    </p>
                    ...
                    <div className="p-8 md:p-12 rounded-[24px] border border-[rgba(255,255,255,0.08)] bg-[#0B0F1A] shadow-xl relative overflow-hidden group">
                        ...
                        <div className="relative z-10">
                            ...
                            <p className="text-zinc-400 mb-8 max-w-lg">
                                Book a strategy call to discover how our AI automation systems can transform your revenue operations.
                            </p>
