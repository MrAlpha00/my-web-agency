                ...
                <div className="xl:grid xl:grid-cols-3 xl:gap-8">
                    <div className="space-y-8">
                        ...
                        <p className="text-sm leading-6 text-zinc-400 max-w-sm">
                            Crafting premium digital experiences for forward-thinking brands. We build software that scales and designs that inspire.
                        </p>
                        ...
                        <div>
                            ...
                            <ul role="list" className="mt-6 space-y-4">
                                ...
                                <li className="flex gap-x-3">
                                    ...
                                    <span className="text-sm leading-6 text-zinc-400">+1 (555) 123-4567</span>
                                </li>
                                <li className="flex gap-x-3">
                                    <EnvelopeIcon className="h-6 w-5 flex-none text-zinc-400" aria-hidden="true" />
                                    <span className="text-sm leading-6 text-zinc-400">hello@pureons.com</span>
                                </li>
                            </ul>
                        </div>
                    </div>
